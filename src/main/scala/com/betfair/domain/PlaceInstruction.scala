...
case class PlaceInstruction(orderType: OrderType = OrderType.LIMIT, selectionId: Long, handicap: Option[Double] = None,
                            side: Side, limitOrder: Option[LimitOrder] = None,
