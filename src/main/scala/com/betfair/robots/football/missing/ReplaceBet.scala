...
class ReplaceBet(betfairServiceNG: BetfairServiceNG,
                ...
                trend: String)(implicit executionContext: ExecutionContext) extends Actor {
            ...
            runners foreach { runner =>
              ...
              if (runner.selectionId == placeInstructionReport.instruction.get.selectionId) {
                ...
                if (placeInstructionReport.instruction.get.side.equals(Side.LAY)) {
                  ...
                  if ((runner.ex.get.availableToBack.head.price >
                    placeInstructionReport.instruction.get.limitOrder.get.price) && trend.equals("drift")) {

                    val replaceInstructions = Set(
                      ReplaceInstruction(
                        betId = placeInstructionReport.betId.get,
                        newPrice = incrementPrice(incrementPrice(
                              ...
                              case Some(status) if status.equals(InstructionReportStatus.SUCCESS) =>
                                ...
                                system.scheduler.scheduleOnce(
                                  ...
                                  system.actorOf(Props(new ReplaceBet(betfairServiceNG, sessionToken,
                                    marketId, instructionReport.placeInstructionReport, trend)),
                                    DateTime.now().toString
                                      + placeInstructionReport.instruction.get.selectionId +
                                      placeInstructionReport.instruction.get.side), "")

                                println(marketId + " - " + placeInstructionReport.instruction.get.selectionId + " - "
                    ...
                    system.scheduler.scheduleOnce(
                      Duration(5, TimeUnit.SECONDS),
                      system.actorOf(Props(new ReplaceBet(betfairServiceNG, sessionToken,
                        marketId, placeInstructionReport, trend)),
                        DateTime.now().toString
                  ...
                  // bet moved away too much
                  if ((runner.ex.get.availableToLay.head.price <
                    placeInstructionReport.instruction.get.limitOrder.get.price) && trend.equals("steam")) {

                    val replaceInstructions = Set(
                      ReplaceInstruction(
                        betId = placeInstructionReport.betId.get,
                        newPrice = decrementPrice(decrementPrice(
                          placeInstructionReport.instruction.get.limitOrder.get.price))
                      )
                    )
                              ...
                              case Some(status) if status.equals(InstructionReportStatus.SUCCESS) =>
                                ...
                                system.scheduler.scheduleOnce(
                                  ...
                                  system.actorOf(Props(new ReplaceBet(betfairServiceNG, sessionToken,
                                    marketId, instructionReport.placeInstructionReport, trend)),
                                    DateTime.now().toString
                                      + placeInstructionReport.instruction.get.selectionId + placeInstructionReport.instruction.get.side), "")
