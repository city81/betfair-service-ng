...
class MarketMonitorLay(betfairServiceNG: BetfairServiceNG) extends Actor {

  import MarketMonitorLay._
  import context._
          ...
          betfairServiceNG.listMarketCatalogue(sessionToken, listMarketCatalogueMarketFilter,
            ...
            case Success(Some(listMarketCatalogueContainer)) =>
              for (marketCatalogue <- listMarketCatalogueContainer.result) {
                ...
                val raceActorName = "monitor-lay-" + marketCatalogue.marketId
                ...
                if (child(raceActorName).isEmpty) {
                  ...
                  try {
                    system.scheduler.scheduleOnce(
                      ...
                      system.actorOf(Props(new MonitorPrices(betfairServiceNG, sessionToken,
